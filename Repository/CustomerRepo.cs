...
namespace api2.Repository
{
    public class CustomerRepo:ICustomerRepo
    {
        ...
        public CustomerRepo()
        {
            connectionString = "Data Source=APINP-ELPTKUXQY\\SQLEXPRESS;Initial Catalog=chubb;User ID=tap2023;Password=tap2023;Encrypt=False";
        }
        ...
        public List<Customer> SearchCustomers(string searchCriteria)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                string query = "SELECT CustomerId, CompanyName, Address, Contactname FROM Customers WHERE CompanyName LIKE @SearchCriteria OR ContactName LIKE @SearchCriteria OR Address LIKE @SearchCriteria";
                SqlCommand cmd = new SqlCommand(query, con);
